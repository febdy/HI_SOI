...
public class MongoVo {
	...
	public String toString() {
		return "MongoVo [videoNo=" + videoNo + ", userId=" + userId + ", videoOriginName=" + videoOriginName
				...
				+ ", videoThumnail=" + videoThumnail + ", date=" + date + ", realDate=" + realDate
				+ ", total_video_time=" + total_video_time + ", face_move_cnt_per_5sec=" + face_move_cnt_per_5sec
				+ ", eye_blink_cnt_per_5sec=" + eye_blink_cnt_per_5sec + ", total_grade=" + total_grade + "]";
	}
