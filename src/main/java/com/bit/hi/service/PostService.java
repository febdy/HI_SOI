...
public class PostService {
	...
	public Map<String, Object> getArraySoi(Integer crtPage) {
		...
		List<PostVo> postList = postDao.selectListForArraySoi(startRnum, endRnum);
		// 페이지 하단 숫자버튼 관련 작업
		// 전체 글 갯수
	...
	public Map<String, Object> getArrayLatest(Integer crtPage) {
		...
		List<PostVo> postList = postDao.selectListForArrayLatest(startRnum, endRnum);
		// 페이지 하단 숫자버튼 관련 작업
		// 전체 글 갯수
		int totalCount = postDao.selectTotalCountForArray();
		System.out.println("totalCount :" + totalCount);
	...
	public Map<String, Object> getArrayView(Integer crtPage) {
		...
		List<PostVo> postList = postDao.selectListForArrayView(startRnum, endRnum);
		// 페이지 하단 숫자버튼 관련 작업
		// 전체 글 갯수
		int totalCount = postDao.selectTotalCountForArray();
		System.out.println("totalCount :" + totalCount);
	...
	public Map<String, Object> getArrayComment(Integer crtPage) {
		...
		List<PostVo> postList = postDao.selectListForArrayComment(startRnum, endRnum);
		// 페이지 하단 숫자버튼 관련 작업
		// 전체 글 갯수
		int totalCount = postDao.selectTotalCountForArray();
		System.out.println("totalCount :" + totalCount);
