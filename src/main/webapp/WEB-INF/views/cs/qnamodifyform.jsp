                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="posts-block col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                ...
                                <form class="board-form" method="post" action="${pageContext.request.contextPath}/cs/qna/modify?qna_no=${qnaVo.qna_no}">
                                <div>
                                <label for="lname">제목 </label>
                                </div>
                       			<div class="well">
                                	<input type="text" class="form-control" name="qna_title" value="${requestScope.qnaVo.qna_title}"><br>
                                	</div>
                                	<div>
                                	<label for="lname">내용 </label><br/>
                                	</div>
                                	<div class="well">
                                	<textarea class="form-control" rows="4" name="qna_content">${fn:replace(requestScope.qnaVo.qna_content , ctrl, "</br>" )}</textarea>
								</div>
								<div class="bottom pull-right">
									<c:if test="${authUser.userLevel=='administer'}">
										...
										<a href="${pageContext.request.contextPath}/cs/qna/view/${qnaVo.qna_no}" class="btn btn-color btn-normal btn-pad">취소</a>
									</c:if>
								</div>
								</form>
							</div>
