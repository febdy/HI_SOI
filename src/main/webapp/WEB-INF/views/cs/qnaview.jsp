                        ...
                        <div class="row">
                            ...
                            <div class="posts-block col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class="well">
										...
										<!-- 치환 한 것 기억 -->
										${fn:replace(requestScope.qnaVo.qna_content , ctrl, "</br>" )}
										</div>
								</div>
								...
								<div class="bottom pull-right">
									<c:if test="${authUser.userLevel=='administer'}">
										...
										<a class="btn btn-color btn-normal btn-pad" href="${pageContext.request.contextPath}/cs/qna/modifyform?qna_no=${requestScope.qnaVo.qna_no}">글수정</a>
									</c:if>
								</div>
							</div>
                        </div>
