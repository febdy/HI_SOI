                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                    <div class="breadcrumbs pull-right">
                                        <ul>
                                            ...
                                            <li><a href="index.html">Í≥†Í∞ùÏÑºÌÑ∞</a></li>
                                            <li><a href="#">Q&A</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="sidebar col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="widget category">
                                    ...
                                    <ul class="category-list slide">
                                        <li><a href="${pageContext.request.contextPath}/cs/notice">Í≥µÏßÄÏÇ¨Ìï≠</a></li>
                                        <li><a href="${pageContext.request.contextPath}/cs/qna">Q&A</a></li>
                                        <li><a href="${pageContext.request.contextPath}/cs/help">ÎèÑÏõÄÎßê</a></li>
                                    </ul>
                                </div>
                                <!-- Left nav Widget End -->
                            </div>
                            ...
                            <div class="posts-block col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <h4 class="widget"> Q&A > Í∏ÄÏì∞Í∏∞</h4>
                                <form id="asd" method="post" action="${pageContext.request.contextPath}/cs/qna/write">
                       			<div class="well">
                       			<input type="text" class="form-control" name="qna_title" placeholder="Ï†úÎ™©"><br>
                                <textarea class="form-control" rows="4" name="qna_content" placeholder="ÎÇ¥Ïö©"></textarea>

                                </div>
								
								<div class="row pull-right">
                                    <div class="col-md-3">
                                        <input type="submit" value="Í∏ÄÏì∞Í∏∞" class="btn btn-color btn-normal btn-pad">
                                    </div>
                                </div>
								</form>
							</div>
		...
		<div id="content">
			<div id="board">
				<form class="board-form" method="post" action="${pageContext.request.contextPath }/cs/write">
					...
					<div class="bottom">
						<a href="${pageContext.request.contextPath }/board/list">√Îº“</a>
