...
<body>
	...
	<c:import url="/WEB-INF/views/includes/header.jsp"></c:import>
 	...
 	<ul class="nav nav-tabs" role="tablist">
		...
		<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/interview/upload"
		...
		<div id="content" class="row form-horizontal">
			<div class="col-md-2">
				<ul class="nav nav-pills nav-stacked ">
					<li role="presentation"><a href="${pageContext.request.contextPath}/interview/upload">업로드 모드</a></li>
					<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/interview/live">실시간 모드</a></li>
				</ul>
			</div>
